...
export default tool({
  description:
    "Read the current notification profile (quiet hours, global mute state, watchdog alert enable/mute state, interactive context window size, and context retention cap).",
  args: {},
